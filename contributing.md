...
```bash
git clone https://github.com/<username>/adobe-rules
```
...
[license]: https://github.com/bradgarropy/adobe-rules/blob/master/license
[fork]: https://github.com/bradgarropy/adobe-rules/fork
[contributors]: https://github.com/bradgarropy/adobe-rules#-contributors
